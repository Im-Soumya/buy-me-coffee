...
const Footer = () => {
  return (
    <Flex direction="column" alignItems="center" py="2">
        <Text fontSize={{ base: "xs", md: "sm" }} color="neutral.400">The code for this website is available on <Link textDecor="underline" href={GITHUB_REPO} isExternal>github</Link>.</Text>
